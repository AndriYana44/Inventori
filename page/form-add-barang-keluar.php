    ...
    $(function() {
        ...
        $('#dinas').change(function () { 
            $.get(`${_url}/page/data-json/barang-keluar.php?dinas=${$(this).val()}`, function(res) {
                ...
                if(obj != null) {
                    // perlengkapan kaki
                    $('#pdl_staf').attr('value', `Stock: ${obj.pdl_staf}`);
                    $('#olahraga').attr('value', `Stock: ${obj.olahraga}`);
                    $('#kaos_kaki').attr('value', `Stock: ${obj.kaos_kaki}`);

                    // perlengkapan badan
                    $('#sabhara').attr('value', `Stock: ${obj.sabhara}`);
                    $('#lantas').attr('value', `Stock: ${obj.lantas}`);
                    $('#jaket_staf_pria').attr('value', `Stock: ${obj.jaket_staf_pria}`);
                    $('#jaket_staf_wanita').attr('value', `Stock: ${obj.jaket_staf_wanita}`);
                    $('#baju_sabhara_pria').attr('value', `Stock: ${obj.baju_sabhara_pria}`);
                    $('#baju_sabhara_wanita').attr('value', `Stock: ${obj.baju_sabhara_wanita}`);
                    $('#baju_provos_pria').attr('value', `Stock: ${obj.baju_provos_pria}`);
                    $('#baju_provos_wanita').attr('value', `Stock: ${obj.baju_provos_wanita}`);

                    // perlengkapan kepala
                    $('#jilbab_polwan').attr('value', `Stock: ${obj.jilbab_polwan}`);
                    $('#jilbab_pns').attr('value', `Stock: ${obj.jilbab_pns}`);
                    $('#jilbab_reskrim').attr('value', `Stock: ${obj.jilbab_reskrim}`);
                    $('#topi_gol_1').attr('value', `Stock: ${obj.topi_gol_1}`);
                    $('#topi_gol_2').attr('value', `Stock: ${obj.topi_gol_2}`);
                    $('#topi_gol_3').attr('value', `Stock: ${obj.topi_gol_3}`);
                }else{
                    console.log('error');
                }
            });
        ...
        function validationValue(el) {
            $(el).keyup(function() {
                ...
                if($(this).val() > parseInt(max)) {
                    el_validation.html('Tidak boleh melebihi stock');
                }
                if($(this).val() < parseInt(max)) {
                    el_validation.html('');
                }
